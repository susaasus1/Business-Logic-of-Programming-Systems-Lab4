...
@Component
public class UpdateRecipe implements JavaDelegate {
    private final RecipeService recipeService;

    public UpdateRecipe(RecipeService recipeService) {
    ...
    public void execute(DelegateExecution delegateExecution) {
        ...
        UpdateRecipeRequest updateRecipeRequest = new UpdateRecipeRequest(
                dishName, description, countPortion, nationalCuisineName, tastesNames, ingredientsNames
        );

        try {
            recipeService.updateRecipe(username, recipeId, updateRecipeRequest);
